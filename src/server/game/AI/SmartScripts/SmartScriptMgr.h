...
enum SMART_EVENT
{
    ...
    // GPLP ZONE /// Estos no puede tener salto de varias ids o se rompe el check de si son validos
    SMART_EVENT_SUMMONER_MISSING_BUFF    = 78,      // SpellId, RepeatMin, RepeatMax
...
enum SMART_ACTION
{
    ...
    SMART_ACTION_CHANGE_SEAT                        = 170,    // CurrSeat, NewSeat
...
enum SMARTAI_TARGETS
{
    ...
    // Gplp zone
    //SMART_TARGET_CREATURE_RANDOM                = 40,   // entry, minDist, maxDist
    SMART_TARGET_VEHICLE_PASSENGER              = 41,   // seatId, checkVehicle
...
const uint32 SmartAIEventMask[SMART_EVENT_END][2] =
{
    ...
    {SMART_EVENT_SUMMONER_MISSING_BUFF,     SMART_SCRIPT_TYPE_MASK_CREATURE },
};
